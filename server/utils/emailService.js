        ...
        <div dir="rtl" style="font-family: Arial, sans-serif; line-height: 1.6;">
          ...
          <div style="background-color: #f9f9f9; padding: 15px; border-radius: 5px; margin: 15px 0; border-left: 4px solid #2196F3;">
            ...
            <p style="margin-top: 15px;">
              <a href="${process.env.WEBSITE_URL || 'http://localhost:3000'}/cancel/${booking._id.toString()}" style="background-color: #f44336; color: white; padding: 10px 15px; text-decoration: none; border-radius: 4px; display: inline-block;">לביטול ההזמנה</a>
            </p>
          </div>
