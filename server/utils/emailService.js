...
const sendBookingConfirmation = async (booking, room) => {
  try {
    console.log('מתחיל שליחת אימייל אישור הזמנה:', {
      ...
      guestName: booking.guest.firstName ? `${booking.guest.firstName} ${booking.guest.lastName || ''}` : 'אורח',
      isMultiRoom: booking.isMultiRoomBooking || false
    });
    
    // יצירת שם האורח המלא
    const guestFullName = booking.guest.firstName ? `${booking.guest.firstName} ${booking.guest.lastName || ''}` : 'אורח';
    ...
    const mailOptions = {
      ...
      html: `
        <div dir="rtl" style="font-family: Arial, sans-serif; line-height: 1.5; color: #333; max-width: 600px; margin: 0 auto; font-size: 16px;">
          ...
          <p style="font-size: 18px; margin-bottom: 12px;">שלום <strong>${guestFullName}</strong>,</p>
          ...
          <div style="background-color: #f0f7ff; padding: 20px; border-radius: 8px; margin: 20px 0; border-right: 4px solid #1976d2;">
            ...
            <p style="margin: 10px 0; font-size: 17px;"><strong>שימו לב:</strong> בשבתות ובחגים יהודיים, ניתן לבצע צ'ק-אין רק משעתיים וחצי לאחר השקיעה</p>
            ...
            <div style="margin-top: 15px; border-top: 1px solid #ccc; padding-top: 15px;">
              ...
              <p style="margin: 15px 0; text-align: center;">
                <a href="https://wa.me/972506070260?text=שלום,%20אני%20${encodeURIComponent(guestFullName)}%20פונה%20בנוגע%20להזמה%20מספר%20${booking.bookingNumber}.%20" 
          ...
          <div style="background-color: #f5f5f5; padding: 20px; border-radius: 8px; margin: 20px 0; border-right: 4px solid #1976d2;">
            <table style="width: 100%; border-collapse: collapse; font-size: 17px;">
              ...
              <tr>
                ...
                <td style="padding: 8px 0;">${guestFullName}</td>
              </tr>
              <tr>
